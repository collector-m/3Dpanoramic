/*---------------------------------------------------------------------
2015/06/18: DrawBowlModel		by: 胡诗卉
...
{
	const double aspectRatio = (float)width / height, fieldOfView = 450.0;
...
void display(void)
{
	...
	glLoadIdentity();
	gluLookAt(0.f, 1.f, 5.f, 0.f, 0.f, -5.f, 0.f, 1.f, 0.f);
	...
	if (scene_list == 0)
	{
		...
		drawModel(200, 5, 20, 30, 60, SOLID);
		//drawModel(30, 5, 20, 30, 60, SOLID);
...
int main(int argc, char **argv)
{
	...
	//initTexture("front.bmp", "left.bmp", "Right.bmp", "rear.bmp");
